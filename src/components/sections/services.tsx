          ...
          {categories.map((category, index) => {
            ...
            return (
              <AnimateOnScroll
                ...
                className="h-full"
              >
                <div className="group h-full rounded-xl sm:rounded-2xl border border-[#38BDF8]/20 bg-white p-4 sm:p-6 shadow-sm transition-all duration-300 hover:border-[#38BDF8] hover:shadow-lg">
                  {/* Header */}
